    ...
    return (
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold mb-2">ATS Analysis Results</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <Card className="md:col-span-2">
            ...
            <CardContent className="text-center">
              <div
                className={`text-6xl font-bold mb-2 bg-gradient-to-r ${getScoreGradient(atsResults?.score)} bg-clip-text text-transparent`}
              >
                {atsResults?.score}
              </div>
              <Badge
                className={`text-lg px-4 py-1 ${getScoreColor(atsResults?.score)} bg-transparent border-current`}
              >
                {atsResults?.grade}
              </Badge>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-3xl font-bold mb-2">{atsResults?.skillsMatch}%</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-3xl font-bold mb-2">{atsResults?.keywordsMatch}%</div>
